class CustomerUsersController < ApplicationController
  ...
  # GET /customer_users or /customer_users.json
  def index
    @customer_users = CustomerUser.all
  end

  # GET /customer_users/1 or /customer_users/1.json
  def show
  end
  ...
  # POST /customer_users or /customer_users.json
  def create
  ...
  # PATCH/PUT /customer_users/1 or /customer_users/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /customer_users/1 or /customer_users/1.json
  def destroy
  ...
  private
    ...
    def customer_user_params
      params.require(:customer_user).permit(:customer_id, :user_id, :registered_at)
    end
end
